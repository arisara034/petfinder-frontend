// 🎨 ชุดไอคอนเส้นมินิมอล (แทนที่อีโมจิที่ใช้ทั่วเว็บ)
// ใช้ currentColor เพื่อรับสีจาก parent, ปรับขนาดผ่าน prop size

const paths = {
  search: <><circle cx="11" cy="11" r="7" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></>,
  home: <><path d="M3 11l9-8 9 8" /><path d="M5 10v10a1 1 0 0 0 1 1h4v-6h4v6h4a1 1 0 0 0 1-1V10" /></>,
  pawprint: <>
    <ellipse cx="12" cy="16.2" rx="4" ry="3.2" />
    <ellipse cx="5.5" cy="10.5" rx="1.9" ry="2.4" />
    <ellipse cx="9.3" cy="6.8" rx="1.9" ry="2.4" />
    <ellipse cx="14.7" cy="6.8" rx="1.9" ry="2.4" />
  ...
  sparkles: <><path d="M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5z" /><path d="M19 17l.7 2.1L22 20l-2.3.9L19 23l-.7-2.1L16 20l2.3-.9z" /></>,
  ...
  package: <><path d="M21 8V21H3V8" /><path d="M1 3h22v5H1z" /><line x1="10" y1="12" x2="14" y2="12" /></>,
  filter: <polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3" />,
  navigation: <polygon points="3 11 22 2 13 21 11 13 3 11" />,
  layers: <><polygon points="12 2 2 7 12 12 22 7 12 2" /><polyline points="2 17 12 22 22 17" /><polyline points="2 12 12 17 22 12" /></>,
  heart: <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />,
  arrowRight: <><line x1="5" y1="12" x2="19" y2="12" /><polyline points="12 5 19 12 12 19" /></>,
  lightbulb: <><path d="M9 18h6" /><path d="M10 22h4" /><path d="M12 2a6 6 0 0 0-4 10.47c.61.55 1 1.34 1 2.19V16h6v-1.34c0-.85.39-1.64 1-2.19A6 6 0 0 0 12 2z" /></>,
